...
<div class="main1">
    <p>Admin Modify page<br></p>
</div>
<div class="main">
    <p>Below are three options. Please choose one to modify a entry:</p>
</div>
<div class="main">
    <a href="employee_modify.php"><button class="button button1">Employee</button></a>
    <a href="project_modify.php"><button class="button button1">Project</button></a>
    <a href="department_modify.php"><button class="button button1">Department</button></a>
</div>
