...
<div class="wrapper">
    <div class="top">
        <form action="manager_department_delete.php" method="POST">
            <div class="container">
                <p>Enter Employee ID To Delete: <input type="text" name="id"></p>
                <p>Enter Employee Name To Delete: <input type="text" name="name"></p>
                <p><input type="Submit" value="Delete Id"></p>
            </div>
        </form>
            <div class="container">
                <p>Below will be used to modify the  table:<br></p>
            </div>
        <form action="manager_department_modify.php" method="POST">
            <div class="container">
                <p>Insert Employee ID To Modify: <input type="text" name="e_id"></p>
            </div>
            <div class="container">
                <p>Employee Address: <input type="text" name="e_address"></p>
                <p>Employee Department Number: <input type="text" name="ed_number"></p>
            </div>
            <div class="container">
...
if($mysqli->connect_errno){
    ...
    $sql1 = "SELECT Login_role FROM employeedatabaseaccess WHERE Login_username = '$username' ";
    $result = mysqli_query($mysqli,$sql1);
    $role = mysqli_fetch_assoc($result);
    $_SESSION['Role'] = $role['login_role'];
    ...
    if(!empty($Department_number)){ //if output is greater than 0 create popup. after pressing OK output is given 0 to dismiss the popup
        //$sql = "SELECT * FROM employee WHERE Departments_Department_number = '$Department_number'";
        $sql = "SELECT DISTINCT Name, Employee_id, Total_hours, Address, Departments_Department_number, project_project_id, Login_role FROM employee, employeedatabaseaccess WHERE Login_role = 'employee' AND Departments_Department_number = $Department_number";
